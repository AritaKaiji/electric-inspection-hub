...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen pt-32 pb-16 text-foreground overflow-hidden">
      {/* Hero Image */}
      <div 
        className="absolute inset-0 z-0 opacity-0" // 透過率を0%に設定
        style={{
      ...
      {/* Gradient Overlay */}
      <div 
        className="absolute inset-0 z-10 bg-gradient-to-b from-white/0 via-white/0 to-white/0" // グラデーションの透過率を0%に設定
      />
