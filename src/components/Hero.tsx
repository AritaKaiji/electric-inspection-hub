...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen pt-32 pb-16 text-foreground overflow-hidden">
      {/* Hero Image */}
      <div 
        className="absolute inset-0 z-0 opacity-50" // 透過率を50%に設定
        style={{
      ...
      {/* Gradient Overlay */}
      <div 
        className="absolute inset-0 z-10 bg-gradient-to-b from-white/60 via-white/50 to-white/60" // グラデーションの透過率を調整
      />
